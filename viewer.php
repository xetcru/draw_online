...
if (!empty($table_name)) {
    ...
    if ($structureResult->num_rows > 0) {
        ...
        echo "<div class=\"pagination\" style=\"position:fixed;display:flex;justify-content:center;flex-wrap:wrap;bottom:0;background-color:aqua;width:100%;margin:0;max-height:100px;overflow-y:scroll;\">";
